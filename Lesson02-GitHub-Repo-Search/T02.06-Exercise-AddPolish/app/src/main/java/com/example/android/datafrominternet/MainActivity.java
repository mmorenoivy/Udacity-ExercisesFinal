...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mProgressVarProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressVarProgressBar = (ProgressBar) findViewById(R.id.pb_loading_indicator);
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressVarProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            mProgressVarProgressBar.setVisibility(View.INVISIBLE);
